			...
			<div class="col-sm-12">
				...
				<div class="card bg-white user-detail-wrap">
					...
					<div class="card-header  bg-white">
						...
						<h4 class=""><span class="float-left">Technology List</span> <span class="float-right mr-1"><a href="{{ route('admin.technology.create') }}" class="btn btn-primary">Add</a></span></h4>
    ...
    <script>
        ...
        jQuery(document).ready(function () {        
            ...
            jQuery('#size_table').DataTable({                
                ...
                "serverSide": true,  
                "ajax": {
                   "url": "{{ Route('admin.technology.data.json') }}",
                },
                "columns":[
                    { "data": "sr_no" },
                    { "data": "name" },
                            ...
                            html = `<ul class="p-0">`;
                                        ...
                                        html += `<li class="list-inline-item">
                                            ...
                                            <a class="delete-data info-btn" href="javascript:void(0);"
                                               ...
                                               data-body="Technology will be deleted!"

                                               data-icon="" data-success="Technology successfully deleted!"

                                               data-cancel="Technology is safe!"
                                        ...
                                        html += `<li class="list-inline-item">
                                            ...
                                            <div style="position: relative;" data-table=""
                                                ...
                                                data-success="Technology status successfully updated!"

                                                data-cancel="Technology status did not changed!" title="Update">
